        ...
        return (
            <Fragment>
                 ...
                 <FormGroup>
                    ...
                    <Input name="taiKhoan" value={this.state.user.taiKhoan} onChange={this.handleChange} onKeyUp={this.handleErrors} onBlur={this.handleErrors} placeholder="Tài Khoản" />
