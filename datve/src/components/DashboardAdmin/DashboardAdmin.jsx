            ...
            <div className="col-lg-6 mb-4">
              <div className="card shadow mb-4">
                ...
                <div className="card-body">
                  ...
                  <p>Add some quality, svg illustrations to your project courtesy of <a target="#" rel="nofollow" href="https://undraw.co/">unDraw</a>, a constantly updated collection of beautiful svg images that you can use completely free and without attribution!</p>
                  <a target="#" rel="nofollow" href="https://undraw.co/">Browse Illustrations on unDraw →</a>
                </div>
              </div>
              <div className="card shadow mb-4">
                <div className="card-header py-3">
